  ...
  if (argc > 1)
  {
    ...
    for (int count = 1; count < argc; count++)
    {
      ...
      if(found == 0)
      {
        ...
        //if(MAPPING_POLICY.MAX_MAPPING_ATTEMPTS > 1)
        //  _FATAL("MAPPING_POLICY.MAX_MAPPING_ATTEMPTS is percetntage and should be less than 1\n"); 
      ...
      //found = ims.find(argv[count]); 
      //if(found == 0)
      //{
      //  MAPPING_POLICY.IMS = atof(argv[count + 1]);
      //  count = count + 1;
      //  continue;  
      //}
