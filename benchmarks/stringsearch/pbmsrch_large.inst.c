...
TAU_PROFILE_TIMER(tautimer, "void init_search(const char *) C [{pbmsrch_large.c} {27,1}-{37,1}]", " ", TAU_USER);
...
TAU_PROFILE_TIMER(tautimer, "char *strsearch(const char *) C [{pbmsrch_large.c} {43,1}-{68,1}]", " ", TAU_USER);
	TAU_PROFILE_START(tautimer);
...
#line 62
{ char * tau_ret_val = (here);  TAU_PROFILE_STOP(tautimer); return (tau_ret_val); }
...
#line 67
{ char * tau_ret_val =  NULL;  TAU_PROFILE_STOP(tautimer); return (tau_ret_val); }
...
TAU_PROFILE_TIMER(tautimer, "int main() C [{pbmsrch_large.c} {72,1}-{2755,1}]", " ", TAU_DEFAULT);
#ifndef TAU_MPI
#ifndef TAU_SHMEM
...
#line 2743
{ TAU_PROFILE_TIMER(lt, "Loop: int main() C [{pbmsrch_large.c} {2743,7}-{2752,7}]", " ", TAU_USER); TAU_PROFILE_START(lt); 
