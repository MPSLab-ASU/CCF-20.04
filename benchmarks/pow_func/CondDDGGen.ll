...
4:                                                ; preds = %2
  %5 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([22 x i8], [22 x i8]* @.str, i32 0, i32 0), i32 %0, i32 %1)
  %6 = icmp sgt i32 %1, 2
...
7:                                                ; preds = %4
  ...
  %9 = add nsw i32 %1, -2
  %10 = icmp ult i32 %9, 4
  store i32 %8, i32* @gVar4, align 4
  br i1 %10, label %.preheader, label %11

11:                                               ; preds = %7
  %12 = and i32 %9, -4
  %13 = insertelement <4 x i32> <i32 poison, i32 1, i32 1, i32 1>, i32 %0, i32 0
  %14 = insertelement <4 x i32> poison, i32 %0, i32 0
  %15 = shufflevector <4 x i32> %14, <4 x i32> poison, <4 x i32> zeroinitializer
  br label %16

16:                                               ; preds = %16, %11
  %17 = phi i32 [ 0, %11 ], [ %20, %16 ]
  %18 = phi <4 x i32> [ %13, %11 ], [ %19, %16 ]
  %19 = mul <4 x i32> %18, %15
  %20 = add i32 %17, 4
...
22:                                               ; preds = %16
  %23 = or i32 %12, 1
  %24 = tail call i32 @llvm.vector.reduce.mul.v4i32(<4 x i32> %19)
  %25 = icmp eq i32 %9, %12
  br i1 %25, label %.loopexit, label %.preheader

.preheader:                                       ; preds = %22, %7
  %.ph = phi i32 [ %23, %22 ], [ 1, %7 ]
  %.ph7 = phi i32 [ %24, %22 ], [ %0, %7 ]
  store i32 %.ph, i32* @gVar1, align 4
  store i32 %.ph7, i32* @gVar2, align 4
  store i32 %0, i32* @gVar3, align 4
  %26 = sub i32 %8, %.ph
  %27 = sdiv i32 %26, 1
  store i32 %27, i32* @dynamicTCVal, align 4
  br label %28

28:                                               ; preds = %28, %.preheader
  %29 = phi i32 [ %32, %28 ], [ %.ph, %.preheader ]
  %30 = phi i32 [ %31, %28 ], [ %.ph7, %.preheader ]
  %31 = mul nsw i32 %30, %0
  %32 = add nuw nsw i32 %29, 1
  %33 = icmp eq i32 %32, %8
  br i1 %33, label %.loopexit.loopexit, label %28, !llvm.loop !10

.loopexit.loopexit:                               ; preds = %28
  br label %34

34:                                               ; preds = %.loopexit.loopexit
  %35 = load i32, i32* @gVar5, align 4
  br label %.loopexit

.loopexit:                                        ; preds = %34, %22, %4, %2
  %36 = phi i32 [ 1, %2 ], [ %0, %4 ], [ %24, %22 ], [ %35, %34 ]
  ret i32 %36
}
...
define dso_local i32 @main(i32 %0, i8** nocapture readonly %1) local_unnamed_addr #0 {
  ...
  %4 = load i8*, i8** %3, align 4, !tbaa !12
  %5 = tail call i32 @strtol(i8* nocapture nonnull %4, i8** null, i32 10) #12
  %6 = icmp eq i32 %5, 0
  br i1 %6, label %.loopexit, label %7

7:                                                ; preds = %2
  %8 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([22 x i8], [22 x i8]* @.str, i32 0, i32 0), i32 2, i32 %5) #12
  %9 = icmp sgt i32 %5, 2
  br i1 %9, label %10, label %.loopexit

10:                                               ; preds = %7
  %11 = add nsw i32 %5, -1
  store i32 %11, i32* @gVar6, align 4
  br label %12
...
12:                                               ; preds = %12, %10
  ...
  br i1 %17, label %.loopexit.loopexit, label %12, !llvm.loop !16

.loopexit.loopexit:                               ; preds = %12
  br label %18

18:                                               ; preds = %.loopexit.loopexit
  %19 = load i32, i32* @gVar7, align 4
  br label %.loopexit

.loopexit:                                        ; preds = %18, %7, %2
  %20 = phi i32 [ 1, %2 ], [ 2, %7 ], [ %19, %18 ]
  %21 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([24 x i8], [24 x i8]* @.str.1, i32 0, i32 0), i32 2, i32 %5, i32 %20)
  ret i32 0
}
...
define dso_local i32 @initializeParameters(i32 %0) local_unnamed_addr #4 {
  ...
  %17 = load i32*, i32** @initCGRA, align 4, !tbaa !12
  %18 = add i32 %0, -1
  %19 = mul i32 %18, 7
  %20 = getelementptr inbounds i32, i32* %17, i32 %19
  store i32 2011168768, i32* %20, align 4, !tbaa !17
  %21 = getelementptr inbounds i32, i32* %20, i32 1
  store i32 2011168768, i32* %21, align 4, !tbaa !17
  ...
  %26 = call i32 (i8*, i8*, ...) @sprintf(i8* nonnull %23, i8* nonnull dereferenceable(1) getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1.1, i32 0, i32 0), i32 %0) #12
  ...
  store i8* %65, i8** bitcast (i32** @epilog to i8**), align 4, !tbaa !12
  %66 = shl i32 %58, 3
  %67 = call noalias i8* @malloc(i32 %66) #12
  store i8* %67, i8** bitcast (i32** @prolog to i8**), align 4, !tbaa !12
  %68 = shl i32 %60, 3
  %69 = call noalias i8* @malloc(i32 %68) #12
  store i8* %69, i8** bitcast (i32** @kernel to i8**), align 4, !tbaa !12
  %70 = call i32 @fread(i8* %65, i32 8, i32 %56, %struct._IO_FILE* %45)
  %71 = load i8*, i8** bitcast (i32** @prolog to i8**), align 4, !tbaa !12
  %72 = call i32 @fread(i8* %71, i32 8, i32 %58, %struct._IO_FILE* %46)
  %73 = load i8*, i8** bitcast (i32** @kernel to i8**), align 4, !tbaa !12
  ...
  %79 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %78, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1.1, i32 0, i32 0), i32* nonnull %12) #12
...
88:                                               ; preds = %.preheader
  %89 = call i32 @strtol(i8* nocapture nonnull %80, i8** null, i32 10) #12
  br label %94
...
92:                                               ; preds = %90
  %93 = call i32 @strtol(i8* nocapture nonnull %80, i8** null, i32 10) #12
  br label %94
...
94:                                               ; preds = %92, %88
  ...
  br i1 %98, label %.loopexit.loopexit, label %.preheader, !llvm.loop !19
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %1
  ...
  %120 = call i8* @strcat(i8* nonnull %119, i8* nonnull %25) #12
  ...
  %125 = call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %124, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1.1, i32 0, i32 0), i32* nonnull %15) #12
  ...
  %129 = load i32, i32* %15, align 4, !tbaa !17
  %130 = load i32*, i32** @initCGRA, align 4, !tbaa !12
  ...
  %133 = load i32*, i32** @prolog, align 4, !tbaa !12
  %134 = ptrtoint i32* %133 to i32
  %135 = load i32*, i32** @epilog, align 4, !tbaa !12
  %136 = ptrtoint i32* %135 to i32
  %137 = load i32*, i32** @kernel, align 4, !tbaa !12
  ...
  %140 = load i32*, i32** @prolog, align 4, !tbaa !12
  %141 = ptrtoint i32* %140 to i32
  %142 = load i32*, i32** @prologPtr, align 4, !tbaa !12
  %143 = getelementptr inbounds i32, i32* %142, i32 %18
  store i32 %141, i32* %143, align 4, !tbaa !20
  %144 = load i32*, i32** @epilog, align 4, !tbaa !12
  %145 = ptrtoint i32* %144 to i32
  %146 = load i32*, i32** @epilogPtr, align 4, !tbaa !12
  %147 = getelementptr inbounds i32, i32* %146, i32 %18
  store i32 %145, i32* %147, align 4, !tbaa !20
  %148 = load i32*, i32** @kernel, align 4, !tbaa !12
  %149 = ptrtoint i32* %148 to i32
  %150 = load i32*, i32** @kernelPtr, align 4, !tbaa !12
  %151 = getelementptr inbounds i32, i32* %150, i32 %18
  store i32 %149, i32* %151, align 4, !tbaa !20
...
declare dso_local i8* @strcat(i8* noalias returned writeonly, i8* noalias nocapture readonly) local_unnamed_addr #8
...
; Function Attrs: nofree nounwind
declare dso_local noundef i32 @fread(i8* nocapture noundef, i32 noundef, i32 noundef, %struct._IO_FILE* nocapture noundef) local_unnamed_addr #1

; Function Attrs: inaccessiblememonly nofree nounwind willreturn
declare dso_local noalias noundef i8* @malloc(i32) local_unnamed_addr #10

declare dso_local i32 @__isoc99_fscanf(%struct._IO_FILE*, i8*, ...) local_unnamed_addr #11
...
define dso_local i32 @configureCGRA(i32 %0) local_unnamed_addr #0 {
  ...
  %6 = load i32*, i32** @initCGRA, align 4, !tbaa !12
  %7 = add i32 %0, -1
  %8 = mul i32 %7, 7
  ...
  %14 = call i32 (i8*, i8*, ...) @sprintf(i8* nonnull %12, i8* nonnull dereferenceable(1) getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1.1, i32 0, i32 0), i32 %0) #12
  ...
  store i32 10, i32* @dynamicTCVal, align 4, !tbaa !17
  %17 = icmp slt i32 %11, 1
  br i1 %17, label %18, label %24

18:                                               ; preds = %1
  %19 = add nsw i32 %11, 10
  %20 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([17 x i8], [17 x i8]* @.str.20, i32 0, i32 0), i32 %11, i32 10)
  %21 = load i32*, i32** @initCGRA, align 4, !tbaa !12
  %22 = getelementptr inbounds i32, i32* %21, i32 %8
  %23 = getelementptr inbounds i32, i32* %22, i32 5
  store i32 %19, i32* %23, align 4, !tbaa !17
  br label %24
...
29:                                               ; preds = %29, %24
  ...
  %31 = load i32*, i32** @initCGRA, align 4, !tbaa !12
...
38:                                               ; preds = %29
  %39 = load i32*, i32** @epilogPtr, align 4, !tbaa !12
  ...
  %44 = load i32*, i32** @prologPtr, align 4, !tbaa !12
  ...
  %49 = load i32*, i32** @kernelPtr, align 4, !tbaa !12
...
; Function Attrs: nounwind
define dso_local void @checkTotalLoops() local_unnamed_addr #4 {
  ...
  %5 = tail call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %4, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.26, i32 0, i32 0), i32* nonnull @totalLoops) #12
...
; Function Attrs: nounwind
define dso_local i8* @runOnCGRA() local_unnamed_addr #4 {
  %1 = tail call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([12 x i8], [12 x i8]* @str.36, i32 0, i32 0))
  tail call void asm sideeffect "mov r11,$0", "r"(i32 15) #12, !srcloc !23
  ret i8* null
}

; Function Attrs: nounwind
define dso_local void @accelerateOnCGRA(i32 %0) local_unnamed_addr #4 {
  %2 = tail call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([19 x i8], [19 x i8]* @str.37, i32 0, i32 0))
  %3 = tail call i32 @configureCGRA(i32 2)
  %4 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([35 x i8], [35 x i8]* @.str.30, i32 0, i32 0), i32 2)
  %5 = tail call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([12 x i8], [12 x i8]* @str.36, i32 0, i32 0)) #12
  tail call void asm sideeffect "mov r11,$0", "r"(i32 15) #12, !srcloc !23
  ret void
}
...
; Function Attrs: nounwind
define dso_local void @createCGRA() local_unnamed_addr #4 {
  %1 = alloca [40 x i8], align 1
  %2 = tail call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([11 x i8], [11 x i8]* @str.39, i32 0, i32 0))
  %3 = tail call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([16 x i8], [16 x i8]* @str.35, i32 0, i32 0)) #12
  ...
  %6 = tail call i32 (%struct._IO_FILE*, i8*, ...) @__isoc99_fscanf(%struct._IO_FILE* %5, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.26, i32 0, i32 0), i32* nonnull @totalLoops) #12
  %7 = tail call i32 @fclose(%struct._IO_FILE* %5) #12
  call void @llvm.lifetime.end.p0i8(i64 40, i8* nonnull %4) #12
  %8 = load i32, i32* @totalLoops, align 4, !tbaa !17
  %9 = mul i32 %8, 28
  %10 = tail call noalias i8* @malloc(i32 %9) #12
  store i8* %10, i8** bitcast (i32** @initCGRA to i8**), align 4, !tbaa !12
  %11 = shl i32 %8, 2
  %12 = tail call noalias i8* @malloc(i32 %11) #12
  store i8* %12, i8** bitcast (i32** @prologPtr to i8**), align 4, !tbaa !12
  %13 = tail call noalias i8* @malloc(i32 %11) #12
  store i8* %13, i8** bitcast (i32** @kernelPtr to i8**), align 4, !tbaa !12
  %14 = tail call noalias i8* @malloc(i32 %11) #12
  store i8* %14, i8** bitcast (i32** @epilogPtr to i8**), align 4, !tbaa !12
  %15 = icmp eq i32 %8, 0
...
.preheader:                                       ; preds = %.preheader, %.preheader.preheader
  ...
  %18 = add i32 %16, 1
  %19 = load i32, i32* @totalLoops, align 4, !tbaa !17
...
attributes #3 = { nofree nounwind willreturn "disable-tail-calls"="false" "frame-pointer"="none" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+armv7-a,+d32,+dsp,+fp64,+neon,+vfp2,+vfp2sp,+vfp3,+vfp3d16,+vfp3d16sp,+vfp3sp,-thumb-mode" }
attributes #4 = { nounwind "disable-tail-calls"="false" "frame-pointer"="none" "min-legal-vector-width"="0" "no-jump-tables"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+armv7-a,+d32,+dsp,+fp64,+neon,+vfp2,+vfp2sp,+vfp3,+vfp3d16,+vfp3d16sp,+vfp3sp,-thumb-mode" }
attributes #5 = { nofree nounwind }
attributes #6 = { argmemonly nofree nosync nounwind willreturn writeonly }
attributes #7 = { argmemonly nofree nosync nounwind willreturn }
attributes #8 = { argmemonly nofree nounwind willreturn "disable-tail-calls"="false" "frame-pointer"="none" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+armv7-a,+d32,+dsp,+fp64,+neon,+vfp2,+vfp2sp,+vfp3,+vfp3d16,+vfp3d16sp,+vfp3sp,-thumb-mode" }
attributes #9 = { argmemonly nofree nounwind readonly willreturn }
attributes #10 = { inaccessiblememonly nofree nounwind willreturn "disable-tail-calls"="false" "frame-pointer"="none" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+armv7-a,+d32,+dsp,+fp64,+neon,+vfp2,+vfp2sp,+vfp3,+vfp3d16,+vfp3d16sp,+vfp3sp,-thumb-mode" }
attributes #11 = { "disable-tail-calls"="false" "frame-pointer"="none" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="generic" "target-features"="+armv7-a,+d32,+dsp,+fp64,+neon,+vfp2,+vfp2sp,+vfp3,+vfp3d16,+vfp3d16sp,+vfp3sp,-thumb-mode" }
