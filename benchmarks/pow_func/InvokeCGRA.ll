...
22:                                               ; preds = %16
  %.lcssa = phi <4 x i32> [ %19, %16 ]
  %23 = or i32 %12, 1
  %24 = tail call i32 @llvm.vector.reduce.mul.v4i32(<4 x i32> %.lcssa)
  %25 = icmp eq i32 %9, %12
...
29:                                               ; preds = %.loopexit.loopexit
  %30 = load i32, i32* @gVar5, align 4
  br label %.loopexit

.loopexit:                                        ; preds = %29, %22, %4, %2
  %31 = phi i32 [ 1, %2 ], [ %0, %4 ], [ %24, %22 ], [ %30, %29 ]
  ret i32 %31
}
...
define dso_local i32 @main(i32 %0, i8** nocapture readonly %1) local_unnamed_addr #0 {
  ...
  %4 = load i8*, i8** %3, align 4, !tbaa !10
...
13:                                               ; preds = %.loopexit.loopexit
  %14 = load i32, i32* @gVar7, align 4
  br label %.loopexit

.loopexit:                                        ; preds = %13, %7, %2
  %15 = phi i32 [ 1, %2 ], [ 2, %7 ], [ %14, %13 ]
  %16 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([24 x i8], [24 x i8]* @.str.1, i32 0, i32 0), i32 2, i32 %5, i32 %15)
  ret i32 0
}
...
define dso_local i32 @initializeParameters(i32 %0) local_unnamed_addr #4 {
  ...
  %17 = load i32*, i32** @initCGRA, align 4, !tbaa !10
  %18 = add i32 %0, -1
  %19 = mul i32 %18, 7
  %20 = getelementptr inbounds i32, i32* %17, i32 %19
  store i32 2011168768, i32* %20, align 4, !tbaa !14
  %21 = getelementptr inbounds i32, i32* %20, i32 1
  store i32 2011168768, i32* %21, align 4, !tbaa !14
  ...
  store i8* %65, i8** bitcast (i32** @epilog to i8**), align 4, !tbaa !10
  %66 = shl i32 %58, 3
  %67 = call noalias i8* @malloc(i32 %66) #12
  store i8* %67, i8** bitcast (i32** @prolog to i8**), align 4, !tbaa !10
  %68 = shl i32 %60, 3
  %69 = call noalias i8* @malloc(i32 %68) #12
  store i8* %69, i8** bitcast (i32** @kernel to i8**), align 4, !tbaa !10
  %70 = call i32 @fread(i8* %65, i32 8, i32 %56, %struct._IO_FILE* %45)
  %71 = load i8*, i8** bitcast (i32** @prolog to i8**), align 4, !tbaa !10
  %72 = call i32 @fread(i8* %71, i32 8, i32 %58, %struct._IO_FILE* %46)
  %73 = load i8*, i8** bitcast (i32** @kernel to i8**), align 4, !tbaa !10
...
94:                                               ; preds = %92, %88
  ...
  br i1 %98, label %.loopexit.loopexit, label %.preheader, !llvm.loop !16
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %1
  ...
  store i32 %105, i32* %110, align 4, !tbaa !14
  %111 = load i32, i32* %12, align 4, !tbaa !14
  ...
  %127 = load i32, i32* %15, align 4, !tbaa !14
  %128 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([16 x i8], [16 x i8]* @.str.16, i32 0, i32 0), i32 %127)
  %129 = load i32, i32* %15, align 4, !tbaa !14
  %130 = load i32*, i32** @initCGRA, align 4, !tbaa !10
  %131 = getelementptr inbounds i32, i32* %130, i32 %19
  %132 = getelementptr inbounds i32, i32* %131, i32 5
  store i32 %129, i32* %132, align 4, !tbaa !14
  %133 = load i32*, i32** @prolog, align 4, !tbaa !10
  %134 = ptrtoint i32* %133 to i32
  %135 = load i32*, i32** @epilog, align 4, !tbaa !10
  %136 = ptrtoint i32* %135 to i32
  %137 = load i32*, i32** @kernel, align 4, !tbaa !10
...
define dso_local i32 @configureCGRA(i32 %0) local_unnamed_addr #0 {
  ...
  %6 = load i32*, i32** @initCGRA, align 4, !tbaa !10
  %7 = add i32 %0, -1
  %8 = mul i32 %7, 7
  ...
  store i32 10, i32* @dynamicTCVal, align 4, !tbaa !14
...
29:                                               ; preds = %29, %24
  ...
  %31 = load i32*, i32** @initCGRA, align 4, !tbaa !10
  ...
  %37 = icmp eq i32 %36, 7
  br i1 %37, label %38, label %29, !llvm.loop !19

38:                                               ; preds = %29
  %39 = load i32*, i32** @epilogPtr, align 4, !tbaa !10
  ...
  %44 = load i32*, i32** @prologPtr, align 4, !tbaa !10
  ...
  %49 = load i32*, i32** @kernelPtr, align 4, !tbaa !10
...
define dso_local i8* @runOnCGRA() local_unnamed_addr #4 {
  ...
  tail call void asm sideeffect "mov r11,$0", "r"(i32 15) #12, !srcloc !20
  ret i8* null
}
...
define dso_local void @createCGRA() local_unnamed_addr #4 {
  ...
  %8 = load i32, i32* @totalLoops, align 4, !tbaa !14
  %9 = mul i32 %8, 28
  %10 = tail call noalias i8* @malloc(i32 %9) #12
  store i8* %10, i8** bitcast (i32** @initCGRA to i8**), align 4, !tbaa !10
  %11 = shl i32 %8, 2
  %12 = tail call noalias i8* @malloc(i32 %11) #12
  store i8* %12, i8** bitcast (i32** @prologPtr to i8**), align 4, !tbaa !10
  %13 = tail call noalias i8* @malloc(i32 %11) #12
  store i8* %13, i8** bitcast (i32** @kernelPtr to i8**), align 4, !tbaa !10
  %14 = tail call noalias i8* @malloc(i32 %11) #12
  store i8* %14, i8** bitcast (i32** @epilogPtr to i8**), align 4, !tbaa !10
  %15 = icmp eq i32 %8, 0
...
.preheader:                                       ; preds = %.preheader, %.preheader.preheader
  ...
  %18 = add i32 %16, 1
  %19 = load i32, i32* @totalLoops, align 4, !tbaa !14
  %20 = icmp ugt i32 %18, %19
  br i1 %20, label %.loopexit.loopexit, label %.preheader, !llvm.loop !21
