...
26:                                               ; preds = %.preheader, %26
  %27 = phi i32 [ %30, %26 ], [ %.ph, %.preheader ]
  %28 = phi i32 [ %29, %26 ], [ %.ph7, %.preheader ]
  %29 = mul nsw i32 %28, %0
  %30 = add nuw nsw i32 %27, 1
  %31 = icmp eq i32 %30, %8
  br i1 %31, label %.loopexit.loopexit, label %26, !llvm.loop !10

.loopexit.loopexit:                               ; preds = %26
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %22, %4, %2
  %32 = phi i32 [ 1, %2 ], [ %0, %4 ], [ %24, %22 ], [ %29, %.loopexit.loopexit ]
  ret i32 %32
}
...
12:                                               ; preds = %12, %10
  ...
  br i1 %17, label %.loopexit.loopexit, label %12, !llvm.loop !15

.loopexit.loopexit:                               ; preds = %12
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %7, %2
  %18 = phi i32 [ 1, %2 ], [ 2, %7 ], [ %15, %.loopexit.loopexit ]
  %19 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([24 x i8], [24 x i8]* @.str.1, i32 0, i32 0), i32 2, i32 %5, i32 %18)
  ret i32 0
}
...
define dso_local i32 @initializeParameters(i32 %0) local_unnamed_addr #4 {
  ...
  %17 = load i32*, i32** @initCGRA, align 4, !tbaa !11
  %18 = add i32 %0, -1
  %19 = mul i32 %18, 7
  %20 = getelementptr inbounds i32, i32* %17, i32 %19
  store i32 2011168768, i32* %20, align 4, !tbaa !16
  %21 = getelementptr inbounds i32, i32* %20, i32 1
  store i32 2011168768, i32* %21, align 4, !tbaa !16
  ...
  %58 = load i32, i32* %10, align 4, !tbaa !16
  ...
  store i8* %65, i8** bitcast (i32** @epilog to i8**), align 4, !tbaa !11
  %66 = shl i32 %58, 3
  %67 = call noalias i8* @malloc(i32 %66) #12
  store i8* %67, i8** bitcast (i32** @prolog to i8**), align 4, !tbaa !11
  %68 = shl i32 %60, 3
  %69 = call noalias i8* @malloc(i32 %68) #12
  store i8* %69, i8** bitcast (i32** @kernel to i8**), align 4, !tbaa !11
  %70 = call i32 @fread(i8* %65, i32 8, i32 %56, %struct._IO_FILE* %45)
  %71 = load i8*, i8** bitcast (i32** @prolog to i8**), align 4, !tbaa !11
  %72 = call i32 @fread(i8* %71, i32 8, i32 %58, %struct._IO_FILE* %46)
  %73 = load i8*, i8** bitcast (i32** @kernel to i8**), align 4, !tbaa !11
...
94:                                               ; preds = %92, %88
  ...
  br i1 %98, label %.loopexit.loopexit, label %.preheader, !llvm.loop !18
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %1
  ...
  %104 = sdiv i32 %56, %102
  %105 = sdiv i32 %58, %102
  %106 = load i32*, i32** @initCGRA, align 4, !tbaa !11
  %107 = getelementptr inbounds i32, i32* %106, i32 %19
  %108 = getelementptr inbounds i32, i32* %107, i32 2
  store i32 %103, i32* %108, align 4, !tbaa !16
  %109 = getelementptr inbounds i32, i32* %107, i32 3
  store i32 %104, i32* %109, align 4, !tbaa !16
  %110 = getelementptr inbounds i32, i32* %107, i32 4
  store i32 %105, i32* %110, align 4, !tbaa !16
  %111 = load i32, i32* %12, align 4, !tbaa !16
  ...
  %133 = load i32*, i32** @prolog, align 4, !tbaa !11
  %134 = ptrtoint i32* %133 to i32
  %135 = load i32*, i32** @epilog, align 4, !tbaa !11
  %136 = ptrtoint i32* %135 to i32
  %137 = load i32*, i32** @kernel, align 4, !tbaa !11
  ...
  %140 = load i32*, i32** @prolog, align 4, !tbaa !11
  %141 = ptrtoint i32* %140 to i32
  %142 = load i32*, i32** @prologPtr, align 4, !tbaa !11
  %143 = getelementptr inbounds i32, i32* %142, i32 %18
  store i32 %141, i32* %143, align 4, !tbaa !19
  %144 = load i32*, i32** @epilog, align 4, !tbaa !11
  %145 = ptrtoint i32* %144 to i32
  %146 = load i32*, i32** @epilogPtr, align 4, !tbaa !11
  %147 = getelementptr inbounds i32, i32* %146, i32 %18
  store i32 %145, i32* %147, align 4, !tbaa !19
  %148 = load i32*, i32** @kernel, align 4, !tbaa !11
  %149 = ptrtoint i32* %148 to i32
  %150 = load i32*, i32** @kernelPtr, align 4, !tbaa !11
  %151 = getelementptr inbounds i32, i32* %150, i32 %18
  store i32 %149, i32* %151, align 4, !tbaa !19
...
define dso_local i32 @configureCGRA(i32 %0) local_unnamed_addr #0 {
  ...
  %6 = load i32*, i32** @initCGRA, align 4, !tbaa !11
  %7 = add i32 %0, -1
  %8 = mul i32 %7, 7
  ...
  store i32 10, i32* @dynamicTCVal, align 4, !tbaa !16
...
29:                                               ; preds = %29, %24
  ...
  %31 = load i32*, i32** @initCGRA, align 4, !tbaa !11
  ...
  %37 = icmp eq i32 %36, 7
  br i1 %37, label %38, label %29, !llvm.loop !21

38:                                               ; preds = %29
  %39 = load i32*, i32** @epilogPtr, align 4, !tbaa !11
  ...
  %44 = load i32*, i32** @prologPtr, align 4, !tbaa !11
  ...
  %49 = load i32*, i32** @kernelPtr, align 4, !tbaa !11
...
define dso_local i8* @runOnCGRA() local_unnamed_addr #4 {
  ...
  tail call void asm sideeffect "mov r11,$0", "r"(i32 15) #12, !srcloc !22
  ret i8* null
}
...
define dso_local void @createCGRA() local_unnamed_addr #4 {
  ...
  %8 = load i32, i32* @totalLoops, align 4, !tbaa !16
  %9 = mul i32 %8, 28
  %10 = tail call noalias i8* @malloc(i32 %9) #12
  store i8* %10, i8** bitcast (i32** @initCGRA to i8**), align 4, !tbaa !11
  %11 = shl i32 %8, 2
  %12 = tail call noalias i8* @malloc(i32 %11) #12
  store i8* %12, i8** bitcast (i32** @prologPtr to i8**), align 4, !tbaa !11
  %13 = tail call noalias i8* @malloc(i32 %11) #12
  store i8* %13, i8** bitcast (i32** @kernelPtr to i8**), align 4, !tbaa !11
  %14 = tail call noalias i8* @malloc(i32 %11) #12
  store i8* %14, i8** bitcast (i32** @epilogPtr to i8**), align 4, !tbaa !11
  %15 = icmp eq i32 %8, 0
...
.preheader:                                       ; preds = %.preheader.preheader, %.preheader
  ...
  %18 = add i32 %16, 1
  %19 = load i32, i32* @totalLoops, align 4, !tbaa !16
  %20 = icmp ugt i32 %18, %19
  br i1 %20, label %.loopexit.loopexit, label %.preheader, !llvm.loop !23
