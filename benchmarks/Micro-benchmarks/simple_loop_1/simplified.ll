...
source_filename = "/home/local/ASUAD/quoclon1/CCF_INS/ins3/scripts/CGRALib/cgra.c"
...
define dso_local i32 @initializeParameters(i32 %0) local_unnamed_addr #0 !dbg !47 {
  ...
  br i1 %83, label %101, label %.preheader, !dbg !228
...
92:                                               ; preds = %84
  ...
  br i1 %93, label %94, label %.loopexit, !dbg !248
...
96:                                               ; preds = %94, %90
  ...
  br i1 %100, label %.loopexit, label %84, !dbg !228, !llvm.loop !252
...
101:                                              ; preds = %.loopexit, %1
  %102 = phi i32 [ 0, %1 ], [ %.ph, %.loopexit ], !dbg !257
  %103 = phi i32 [ 0, %1 ], [ %.ph1, %.loopexit ], !dbg !148
  %104 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([39 x i8], [39 x i8]* @.str.15, i32 0, i32 0), i32 %103, i32 %102), !dbg !256
  call void @llvm.dbg.value(metadata i32 %60, metadata !134, metadata !DIExpression()), !dbg !148
...
define dso_local void @createCGRA() local_unnamed_addr #0 !dbg !432 {
  ...
  br i1 %15, label %22, label %.preheader, !dbg !462
...
16:                                               ; preds = %.preheader, %16
  ...
  br i1 %21, label %.loopexit, label %16, !dbg !462, !llvm.loop !467
...
!3 = !DIFile(filename: "/home/local/ASUAD/quoclon1/CCF_INS/ins3/scripts/CGRALib/cgra.c", directory: "/home/local/ASUAD/quoclon1/CCF_INS/ins3/benchmarks/Micro-benchmarks/simple_loop_1")
!4 = !{}
!5 = !{!6, !8, !7, !9, !10, !11, !12}
...
!18 = !DIFile(filename: "scripts/CGRALib/cgra.h", directory: "/home/local/ASUAD/quoclon1/CCF_INS/ins3")
...
!46 = !{!"clang version 13.0.0 (https://github.com/llvm/llvm-project.git 0d4534237de38fcf1b2a71bcb0f74cb5675fe7e1)"}
...
!48 = !DIFile(filename: "scripts/CGRALib/cgra.c", directory: "/home/local/ASUAD/quoclon1/CCF_INS/ins3")
...
!256 = !DILocation(line: 96, column: 3, scope: !47)
!257 = !DILocation(line: 82, column: 15, scope: !47)
