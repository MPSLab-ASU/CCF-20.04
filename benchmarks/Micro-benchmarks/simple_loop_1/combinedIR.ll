...
.preheader:                                       ; preds = %.preheader.preheader, %.preheader
  ...
  %8 = phi i32 [ %11, %.preheader ], [ 0, %.preheader.preheader ]
  %9 = icmp ult i32 %7, 5
  %10 = add nsw i32 %8, 33
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %2
  %14 = phi i32 [ 0, %2 ], [ %5, %.loopexit.loopexit ]
  %15 = phi i32 [ 0, %2 ], [ %11, %.loopexit.loopexit ]
  %16 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([33 x i8], [33 x i8]* @.str, i32 0, i32 0), i32 %5, i32 %15, i32 %14)
  ret i32 0
}
