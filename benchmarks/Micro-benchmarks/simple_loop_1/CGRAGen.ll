...
.loopexit:                                        ; preds = %10, %2
  ...
  %14 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([33 x i8], [33 x i8]* @.str, i32 0, i32 0), i32 %5, i32 %13, i32 %12)
...
95:                                               ; preds = %93, %89
  ...
  br i1 %99, label %.loopexit.loopexit, label %.preheader, !llvm.loop !11
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %1
  ...
  store i32 %106, i32* %111, align 4, !tbaa !9
  %112 = load i32, i32* %12, align 4, !tbaa !9
  ...
  store i32 %130, i32* %133, align 4, !tbaa !9
  ...
  store i32 %142, i32* %144, align 4, !tbaa !14
...
29:                                               ; preds = %29, %24
  ...
  %37 = icmp eq i32 %36, 7
  br i1 %37, label %38, label %29, !llvm.loop !16
