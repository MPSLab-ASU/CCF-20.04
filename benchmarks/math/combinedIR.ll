...
.loopexit:                                        ; preds = %.loopexit.loopexit, %19, %4, %2
  %28 = phi i32 [ 1, %2 ], [ %0, %4 ], [ %20, %19 ], [ %25, %.loopexit.loopexit ]
  ret i32 %28
}
...
.loopexit2:                                       ; preds = %.loopexit2.loopexit, %14, %2
  %4 = phi i32 [ 0, %2 ], [ %15, %14 ], [ %27, %.loopexit2.loopexit ]
  ret i32 %4

.preheader:                                       ; preds = %.preheader.preheader, %.loopexit
  %5 = phi i32 [ %7, %.loopexit ], [ %1, %.preheader.preheader ]
  %6 = phi i32 [ %27, %.loopexit ], [ 0, %.preheader.preheader ]
  %7 = add nsw i32 %5, -1
...
20:                                               ; preds = %20, %18
  ...
  %22 = phi i32 [ %23, %20 ], [ 2, %18 ]
  %23 = shl nsw i32 %22, 1
  %24 = add nuw nsw i32 %21, 1
  %25 = icmp eq i32 %24, %19
  br i1 %25, label %.loopexit.loopexit, label %20, !llvm.loop !16

.loopexit.loopexit:                               ; preds = %20
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %16, %.preheader
  %26 = phi i32 [ 0, %.preheader ], [ 2, %16 ], [ %23, %.loopexit.loopexit ]
  %27 = add nsw i32 %26, %6
  %28 = icmp sgt i32 %5, 1
  br i1 %28, label %.preheader, label %.loopexit2.loopexit, !llvm.loop !17
}

; Function Attrs: nofree nounwind
define dso_local i32 @main(i32 %0, i8** nocapture readonly %1) local_unnamed_addr #3 {
  %3 = getelementptr inbounds i8*, i8** %1, i32 1
  %4 = load i8*, i8** %3, align 4, !tbaa !18
...
10:                                               ; preds = %2
  ...
  %12 = load i8*, i8** %3, align 4, !tbaa !18
...
.preheader:                                       ; preds = %.preheader.preheader, %.loopexit
  ...
  %18 = phi i32 [ %39, %.loopexit ], [ 0, %.preheader.preheader ]
  %19 = add nsw i32 %17, -1
...
32:                                               ; preds = %32, %30
  %33 = phi i32 [ %36, %32 ], [ 0, %30 ]
  %34 = phi i32 [ %35, %32 ], [ 2, %30 ]
  %35 = shl nsw i32 %34, 1
  %36 = add nuw nsw i32 %33, 1
  %37 = icmp eq i32 %36, %31
  br i1 %37, label %.loopexit.loopexit, label %32, !llvm.loop !20

.loopexit.loopexit:                               ; preds = %32
  br label %.loopexit

.loopexit:                                        ; preds = %.loopexit.loopexit, %28, %.preheader
  %38 = phi i32 [ 0, %.preheader ], [ 2, %28 ], [ %35, %.loopexit.loopexit ]
  %39 = add nsw i32 %38, %18
  %40 = icmp sgt i32 %17, 1
  br i1 %40, label %.preheader, label %.loopexit2.loopexit, !llvm.loop !21

.loopexit2.loopexit:                              ; preds = %.loopexit
  br label %.loopexit2

.loopexit2:                                       ; preds = %.loopexit2.loopexit, %26, %10
  %41 = phi i32 [ 0, %10 ], [ %27, %26 ], [ %39, %.loopexit2.loopexit ]
  %42 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([23 x i8], [23 x i8]* @.str.3, i32 0, i32 0), i32 %41)
  br label %65
...
46:                                               ; preds = %43
  %47 = tail call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([11 x i8], [11 x i8]* @str, i32 0, i32 0))
  %48 = load i8*, i8** %3, align 4, !tbaa !18
  %49 = tail call i32 @strtol(i8* nocapture nonnull %48, i8** null, i32 10) #14
  %50 = mul nsw i32 %6, -100
  %51 = add i32 %49, %50
  %52 = icmp eq i32 %51, 0
...
53:                                               ; preds = %46
  ...
  br i1 %54, label %55, label %.loopexit3
...
57:                                               ; preds = %57, %55
  %58 = phi i32 [ %61, %57 ], [ 0, %55 ]
  %59 = phi i32 [ %60, %57 ], [ 2, %55 ]
  %60 = shl nsw i32 %59, 1
  %61 = add nuw nsw i32 %58, 1
  %62 = icmp eq i32 %61, %56
  br i1 %62, label %.loopexit3.loopexit, label %57, !llvm.loop !22

.loopexit3.loopexit:                              ; preds = %57
  br label %.loopexit3

.loopexit3:                                       ; preds = %.loopexit3.loopexit, %53, %46
  %63 = phi i32 [ 1, %46 ], [ 2, %53 ], [ %60, %.loopexit3.loopexit ]
  %64 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([23 x i8], [23 x i8]* @.str.5, i32 0, i32 0), i32 %51, i32 %63)
  br label %65

65:                                               ; preds = %.loopexit3, %43, %.loopexit2
  ret i32 0
}
...
define dso_local i32 @initializeParameters(i32 %0) local_unnamed_addr #7 {
  ...
  %17 = load i32*, i32** @initCGRA, align 4, !tbaa !18
  %18 = add i32 %0, -1
  %19 = mul i32 %18, 7
  %20 = getelementptr inbounds i32, i32* %17, i32 %19
  store i32 2011168768, i32* %20, align 4, !tbaa !23
  %21 = getelementptr inbounds i32, i32* %20, i32 1
  store i32 2011168768, i32* %21, align 4, !tbaa !23
  ...
  store i8* %65, i8** bitcast (i32** @epilog to i8**), align 4, !tbaa !18
  %66 = shl i32 %58, 3
  %67 = call noalias i8* @malloc(i32 %66) #14
  store i8* %67, i8** bitcast (i32** @prolog to i8**), align 4, !tbaa !18
  %68 = shl i32 %60, 3
  %69 = call noalias i8* @malloc(i32 %68) #14
  store i8* %69, i8** bitcast (i32** @kernel to i8**), align 4, !tbaa !18
  %70 = call i32 @fread(i8* %65, i32 8, i32 %56, %struct._IO_FILE* %45)
  %71 = load i8*, i8** bitcast (i32** @prolog to i8**), align 4, !tbaa !18
  %72 = call i32 @fread(i8* %71, i32 8, i32 %58, %struct._IO_FILE* %46)
  %73 = load i8*, i8** bitcast (i32** @kernel to i8**), align 4, !tbaa !18
...
95:                                               ; preds = %93, %89
  ...
  br i1 %99, label %.loopexit.loopexit, label %.preheader, !llvm.loop !25
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %1
  ...
  %105 = sdiv i32 %56, %103
  %106 = sdiv i32 %58, %103
  %107 = load i32*, i32** @initCGRA, align 4, !tbaa !18
  %108 = getelementptr inbounds i32, i32* %107, i32 %19
  %109 = getelementptr inbounds i32, i32* %108, i32 2
  store i32 %104, i32* %109, align 4, !tbaa !23
  %110 = getelementptr inbounds i32, i32* %108, i32 3
  store i32 %105, i32* %110, align 4, !tbaa !23
  %111 = getelementptr inbounds i32, i32* %108, i32 4
  store i32 %106, i32* %111, align 4, !tbaa !23
  %112 = load i32, i32* %12, align 4, !tbaa !23
  ...
  %128 = load i32, i32* %15, align 4, !tbaa !23
  %129 = call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([16 x i8], [16 x i8]* @.str.17, i32 0, i32 0), i32 %128)
  %130 = load i32, i32* %15, align 4, !tbaa !23
  %131 = load i32*, i32** @initCGRA, align 4, !tbaa !18
  %132 = getelementptr inbounds i32, i32* %131, i32 %19
  %133 = getelementptr inbounds i32, i32* %132, i32 5
  store i32 %130, i32* %133, align 4, !tbaa !23
  %134 = load i32*, i32** @prolog, align 4, !tbaa !18
  %135 = ptrtoint i32* %134 to i32
  %136 = load i32*, i32** @epilog, align 4, !tbaa !18
  %137 = ptrtoint i32* %136 to i32
  %138 = load i32*, i32** @kernel, align 4, !tbaa !18
  ...
  %141 = load i32*, i32** @prolog, align 4, !tbaa !18
  %142 = ptrtoint i32* %141 to i32
  %143 = load i32*, i32** @prologPtr, align 4, !tbaa !18
  %144 = getelementptr inbounds i32, i32* %143, i32 %18
  store i32 %142, i32* %144, align 4, !tbaa !26
  %145 = load i32*, i32** @epilog, align 4, !tbaa !18
  %146 = ptrtoint i32* %145 to i32
  %147 = load i32*, i32** @epilogPtr, align 4, !tbaa !18
  %148 = getelementptr inbounds i32, i32* %147, i32 %18
  store i32 %146, i32* %148, align 4, !tbaa !26
  %149 = load i32*, i32** @kernel, align 4, !tbaa !18
  %150 = ptrtoint i32* %149 to i32
  %151 = load i32*, i32** @kernelPtr, align 4, !tbaa !18
  %152 = getelementptr inbounds i32, i32* %151, i32 %18
  store i32 %150, i32* %152, align 4, !tbaa !26
...
define dso_local i32 @configureCGRA(i32 %0) local_unnamed_addr #3 {
  ...
  %6 = load i32*, i32** @initCGRA, align 4, !tbaa !18
  %7 = add i32 %0, -1
  %8 = mul i32 %7, 7
...
18:                                               ; preds = %1
  %19 = load i32, i32* @dynamicTCVal, align 4, !tbaa !23
  %20 = add nsw i32 %19, %11
  %21 = load i32*, i32** @initCGRA, align 4, !tbaa !18
...
29:                                               ; preds = %29, %24
  ...
  %31 = load i32*, i32** @initCGRA, align 4, !tbaa !18
  ...
  %37 = icmp eq i32 %36, 7
  br i1 %37, label %38, label %29, !llvm.loop !28

38:                                               ; preds = %29
  %39 = load i32*, i32** @epilogPtr, align 4, !tbaa !18
  ...
  %44 = load i32*, i32** @prologPtr, align 4, !tbaa !18
  ...
  %49 = load i32*, i32** @kernelPtr, align 4, !tbaa !18
...
define dso_local i8* @runOnCGRA() local_unnamed_addr #7 {
  ...
  tail call void asm sideeffect "mov r11,$0", "r"(i32 15) #14, !srcloc !29
  ret i8* null
}
...
define dso_local void @createCGRA() local_unnamed_addr #7 {
  ...
  %8 = load i32, i32* @totalLoops, align 4, !tbaa !23
  %9 = mul i32 %8, 28
  %10 = tail call noalias i8* @malloc(i32 %9) #14
  store i8* %10, i8** bitcast (i32** @initCGRA to i8**), align 4, !tbaa !18
  %11 = shl i32 %8, 2
  %12 = tail call noalias i8* @malloc(i32 %11) #14
  store i8* %12, i8** bitcast (i32** @prologPtr to i8**), align 4, !tbaa !18
  %13 = tail call noalias i8* @malloc(i32 %11) #14
  store i8* %13, i8** bitcast (i32** @kernelPtr to i8**), align 4, !tbaa !18
  %14 = tail call noalias i8* @malloc(i32 %11) #14
  store i8* %14, i8** bitcast (i32** @epilogPtr to i8**), align 4, !tbaa !18
  %15 = icmp eq i32 %8, 0
...
.preheader:                                       ; preds = %.preheader.preheader, %.preheader
  ...
  %18 = add i32 %16, 1
  %19 = load i32, i32* @totalLoops, align 4, !tbaa !23
  %20 = icmp ugt i32 %18, %19
  br i1 %20, label %.loopexit.loopexit, label %.preheader, !llvm.loop !30
