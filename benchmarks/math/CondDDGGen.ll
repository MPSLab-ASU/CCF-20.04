...
25:                                               ; preds = %25, %.preheader
  %26 = phi i32 [ %29, %25 ], [ %.ph, %.preheader ]
  %27 = phi i32 [ %28, %25 ], [ %.ph7, %.preheader ]
  %28 = mul nsw i32 %27, %0
  %29 = add nuw nsw i32 %26, 1
  %30 = icmp eq i32 %29, %7
  br i1 %30, label %.loopexit.loopexit, label %25, !llvm.loop !12

.loopexit.loopexit:                               ; preds = %25
  br label %31

31:                                               ; preds = %.loopexit.loopexit
  %32 = load i32, i32* @gVar5, align 4
  br label %.loopexit

.loopexit:                                        ; preds = %31, %20, %4, %2
  %33 = phi i32 [ 1, %2 ], [ %0, %4 ], [ %21, %20 ], [ %32, %31 ]
  ret i32 %33
}
...
20:                                               ; preds = %20, %18
  ...
  br i1 %25, label %.loopexit.loopexit, label %20, !llvm.loop !17

.loopexit.loopexit:                               ; preds = %20
  br label %26

26:                                               ; preds = %.loopexit.loopexit
  %27 = load i32, i32* @gVar7, align 4
  br label %.loopexit

.loopexit:                                        ; preds = %26, %16, %.preheader
  %28 = phi i32 [ 0, %.preheader ], [ 2, %16 ], [ %27, %26 ]
  %29 = add nsw i32 %28, %6
  %30 = icmp sgt i32 %5, 1
  br i1 %30, label %.preheader, label %.loopexit2.loopexit, !llvm.loop !18
}
...
.preheader:                                       ; preds = %.loopexit, %.preheader.preheader
  ...
  %18 = phi i32 [ %41, %.loopexit ], [ 0, %.preheader.preheader ]
  %19 = add nsw i32 %17, -1
...
32:                                               ; preds = %32, %30
  ...
  br i1 %37, label %.loopexit.loopexit, label %32, !llvm.loop !21

.loopexit.loopexit:                               ; preds = %32
  br label %38

38:                                               ; preds = %.loopexit.loopexit
  %39 = load i32, i32* @gVar9, align 4
  br label %.loopexit

.loopexit:                                        ; preds = %38, %28, %.preheader
  %40 = phi i32 [ 0, %.preheader ], [ 2, %28 ], [ %39, %38 ]
  %41 = add nsw i32 %40, %18
  %42 = icmp sgt i32 %17, 1
  br i1 %42, label %.preheader, label %.loopexit2.loopexit, !llvm.loop !22

.loopexit2.loopexit:                              ; preds = %.loopexit
  br label %.loopexit2

.loopexit2:                                       ; preds = %.loopexit2.loopexit, %26, %10
  %43 = phi i32 [ 0, %10 ], [ %27, %26 ], [ %41, %.loopexit2.loopexit ]
  %44 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([23 x i8], [23 x i8]* @.str.3, i32 0, i32 0), i32 %43)
  br label %69
...
48:                                               ; preds = %45
  %49 = tail call i32 @puts(i8* nonnull dereferenceable(1) getelementptr inbounds ([11 x i8], [11 x i8]* @str, i32 0, i32 0))
  %50 = load i8*, i8** %3, align 4, !tbaa !19
  %51 = tail call i32 @strtol(i8* nocapture nonnull %50, i8** null, i32 10) #14
  %52 = mul nsw i32 %6, -100
  %53 = add i32 %51, %52
  %54 = icmp eq i32 %53, 0
  br i1 %54, label %.loopexit3, label %55
...
57:                                               ; preds = %55
  %58 = add nsw i32 %53, -1
  store i32 %58, i32* @gVar10, align 4
  br label %59

59:                                               ; preds = %59, %57
  %60 = phi i32 [ %63, %59 ], [ 0, %57 ]
  %61 = phi i32 [ %62, %59 ], [ 2, %57 ]
  %62 = shl nsw i32 %61, 1
  %63 = add nuw nsw i32 %60, 1
  %64 = icmp eq i32 %63, %58
  br i1 %64, label %.loopexit3.loopexit, label %59, !llvm.loop !23

.loopexit3.loopexit:                              ; preds = %59
  br label %65

65:                                               ; preds = %.loopexit3.loopexit
  %66 = load i32, i32* @gVar11, align 4
  br label %.loopexit3

.loopexit3:                                       ; preds = %65, %55, %48
  %67 = phi i32 [ 1, %48 ], [ 2, %55 ], [ %66, %65 ]
  %68 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([23 x i8], [23 x i8]* @.str.5, i32 0, i32 0), i32 %53, i32 %67)
  br label %69

69:                                               ; preds = %.loopexit3, %45, %.loopexit2
  ret i32 0
}
...
define dso_local i32 @initializeParameters(i32 %0) local_unnamed_addr #7 {
  ...
  store i32 2011168768, i32* %20, align 4, !tbaa !24
  %21 = getelementptr inbounds i32, i32* %20, i32 1
  store i32 2011168768, i32* %21, align 4, !tbaa !24
...
95:                                               ; preds = %93, %89
  ...
  br i1 %99, label %.loopexit.loopexit, label %.preheader, !llvm.loop !26
...
.loopexit:                                        ; preds = %.loopexit.loopexit, %1
  ...
  store i32 %104, i32* %109, align 4, !tbaa !24
  %110 = getelementptr inbounds i32, i32* %108, i32 3
  store i32 %105, i32* %110, align 4, !tbaa !24
  %111 = getelementptr inbounds i32, i32* %108, i32 4
  store i32 %106, i32* %111, align 4, !tbaa !24
  %112 = load i32, i32* %12, align 4, !tbaa !24
  ...
  store i32 %130, i32* %133, align 4, !tbaa !24
  ...
  store i32 %142, i32* %144, align 4, !tbaa !27
...
18:                                               ; preds = %1
  %19 = load i32, i32* @dynamicTCVal, align 4, !tbaa !24
  ...
  store i32 %20, i32* %23, align 4, !tbaa !24
  br label %24
...
define dso_local i8* @runOnCGRA() local_unnamed_addr #7 {
  ...
  tail call void asm sideeffect "mov r11,$0", "r"(i32 15) #14, !srcloc !30
  ret i8* null
}
...
define dso_local void @createCGRA() local_unnamed_addr #7 {
  ...
  %8 = load i32, i32* @totalLoops, align 4, !tbaa !24
  %9 = mul i32 %8, 28
...
.preheader:                                       ; preds = %.preheader, %.preheader.preheader
  ...
  %18 = add i32 %16, 1
  %19 = load i32, i32* @totalLoops, align 4, !tbaa !24
  %20 = icmp ugt i32 %18, %19
  br i1 %20, label %.loopexit.loopexit, label %.preheader, !llvm.loop !31
...
!12 = distinct !{!12, !6, !13, !7, !8}
!13 = !{!"llvm.loop.CGRA.enable"}
!14 = !{!15, !15, i64 0}
!15 = !{!"omnipotent char", !16, i64 0}
!16 = !{!"Simple C/C++ TBAA"}
!17 = distinct !{!17, !6, !13, !7}
!18 = distinct !{!18, !6, !7}
!19 = !{!20, !20, i64 0}
!20 = !{!"any pointer", !15, i64 0}
!21 = distinct !{!21, !6, !13, !7}
!22 = distinct !{!22, !6, !7}
!23 = distinct !{!23, !6, !13, !7}
!24 = !{!25, !25, i64 0}
!25 = !{!"int", !15, i64 0}
!26 = distinct !{!26, !6, !7}
!27 = !{!28, !28, i64 0}
